export const en = {
  ...
  billing: {
    ...
    benefit: {
      ...
      accounts: 'Tax-advantaged and multiple accounts, with withdrawal ordering',
      withdrawal: 'Optimize the order accounts are drawn down',
      plans: 'Unlimited plans and assets',
    },
    locked: {

export const en = {
  ...
  savings: {
    ...
    automaticTitle: 'Split automatically',
    ...
    spreadButtonShort_one: 'Split across {{count}} asset',
    spreadButtonShort_other: 'Split across {{count}} assets',
    spreadAction: 'Split',
    ...
    columnAsset: 'Asset',
    columnMonthly: 'Monthly contribution',
    columnAnnual: 'Annual savings',
    ...
    annualShort: 'Annual savings',
    projectedAt: 'Projected at {{year}} (with CAGR)',
    projectedShort: 'Projected in {{year}}',
    ...
    yearlyShort: '{{amount}} / yr',
    projectedBy: '{{amount}} by {{year}} (with CAGR)',
    projectedByShort: '{{amount}} in {{year}}',
    perYr: '{{amount}}/yr',
  },
  spending: {
  ...
  accounts: {
    ...
    accountsSummary_one: '{{count}} account · {{assets}} assets',
    accountsSummary_other: '{{count}} accounts · {{assets}} assets',

export const en = {
  ...
  expensesIncomes: {
    ...
    desc: 'Cashflows tied to specific year(s) — education costs, an inheritance received, or other exceptional expenses and income. One-time flows land in a single year; recurring flows repeat every year across a range. Expenses draw from the portfolio, inflows are added to it.',

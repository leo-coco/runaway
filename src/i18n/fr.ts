...
export const fr: Resources = {
  ...
  goalSeek: {
    cutSpending: 'Réduire le revenu retraite cible',
    retireLater: 'Partir plus tard',
    saveMore: 'Épargner plus',
    addCapital: 'Ajouter du capital',
    appliedTitle: 'Dépenses et retraite',
    appliedHint: 'Modifie directement les réglages de votre plan.',
    exploratoryTitle: 'Portefeuille',
    exploratoryHint: 'Réparti sur vos positions existantes, au prorata de leur valeur.',
    ...
    bottomHint: '« Appliquer la combinaison » modifie votre plan et vos positions.',
    confirmTitle: 'Confirmer les changements',
    confirmDesc: 'Voici ce qui va changer dans votre plan. Vérifiez avant de valider.',
    confirmHoldingsCount: 'Réparti sur {{count}} position(s) existante(s).',

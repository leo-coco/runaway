...
export const fr: Resources = {
  ...
  savings: {
    ...
    automaticTitle: 'Répartir automatiquement',
    ...
    spreadButtonShort_one: 'Répartir sur {{count}} actif',
    spreadButtonShort_other: 'Répartir sur {{count}} actifs',
    ...
    columnAsset: 'Actif',
    columnMonthly: 'Contribution mensuelle',
    columnAnnual: 'Épargne annuelle',
    ...
    annualShort: 'Épargne annuelle',
    projectedAt: 'Projeté en {{year}} (avec CAGR)',
    projectedShort: 'Projeté en {{year}}',
    ...
    yearlyShort: '{{amount}} / an',
    projectedBy: '{{amount}} d’ici {{year}} (avec CAGR)',
    projectedByShort: '{{amount}} en {{year}}',
    perYr: '{{amount}}/an',
  },
  spending: {
  ...
  expensesIncomes: {
    ...
    summaryIncome: 'Entrées',
    summaryExpense: 'Dépenses',
    summaryNet: 'Solde net',
    summaryCount: 'Flux',
  ...
  accounts: {
    ...
    accountsSummary_one: '{{count}} compte · {{assets}} actifs',
    accountsSummary_other: '{{count}} comptes · {{assets}} actifs',

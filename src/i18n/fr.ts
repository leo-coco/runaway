...
export const fr: Resources = {
  ...
  expensesIncomes: {
    ...
    desc: 'Flux de trésorerie liés à une ou plusieurs années — frais d’études, héritage reçu ou autres dépenses et revenus exceptionnels. Un flux ponctuel tombe sur une seule année ; un flux périodique se répète chaque année sur une plage. Les dépenses sortent du portefeuille, les entrées s’y ajoutent.',
